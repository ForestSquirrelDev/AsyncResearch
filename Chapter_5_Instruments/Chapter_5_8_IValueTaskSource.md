...
````
В итоге получается некий контракт между нашей кастомной реализацией кэшированного объекта, и контрактом асинхронности в рантайме .NET. Мы говорим рантайму: вот наш кэш, вот свойства
